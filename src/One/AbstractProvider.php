...
use Hyhc\Socialite\Contracts\Provider as ProviderContract;
...
abstract class AbstractProvider implements ProviderContract
{
    ...
    {
        $this->clientId = $configure["client_id"];
        $this->redirectUrl = $configure["redirect"];
        $this->clientSecret = $configure["client_secret"];
        return $this;
    }
     ...
     * @return \Hyhc\Socialite\One\User
     */
